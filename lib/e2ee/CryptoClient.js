...
class CryptoClient {
    ...
    async requestOwnUserVerification() {
        LogService_1.LogService.warn("CryptoClient", "requestOwnUserVerification is not supported by the Rust SDK crypto bindings — skipping self-verification. Device will function but may appear unverified to other clients. Consider cross-signing the device via another client or the Admin API.");
        return null;
    }
